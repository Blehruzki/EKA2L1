...
DST='Asphalt23D_N73_newhud_v20.sisx'
...
exe=open('asphalt2_full_patched_audio.exe','rb').read()
...
for idx,(c,u) in ((EXE_IDX,(e_c,e_u)),(LB_IDX,(b_c,b_u)),(MID_IDX,(m_c,m_u))):
...
for _idx, _payload in ((EXE_IDX, exe), (LB_IDX, bar), (MID_IDX, intro)):
